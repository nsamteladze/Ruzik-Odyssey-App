...
Next, checkout this repo and open the project in Unity3D. When you first open the project, Unity will import all the asset, so it will take a little while. Click `Ctrl + B` to build the game. Once done, you can select the start scene from Scenes -> Start Scene and click Play to start the game in Unity3D.
...
To build the game for a particular platform, go to Build -> Build Settings, switch to the platform you want, and click Build.
